...
{
    public partial class Fvents2 : Form
    {
        public Fvents2()
        {
            InitializeComponent();
        ...
        public void list_vents()
        {
            Form1.con.list_deconnecter("select * from vue_vents");
        ...
        private void toperation_Leave(object sender, EventArgs e)
        {
            if (toperation.Text != "")
            {
                ...
                {
                    Form1.con.list_deconnecter("select date_operation,id_personne,id_produit,id_paiement,qte_operation,prix from vue_vents where id_operation =" + toperation.Text);
        ...
        private void Fvents2_Load(object sender, EventArgs e)
        {
            liste2.Rows.Clear();
            list_vents();
            liste_client();
